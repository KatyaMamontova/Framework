...
<div id="surfaces">
    ...
    <button id="cylinder2" class="crappy">Эллиптический цилиндр</button>
    <button id="cylinderPrb" class="crappy">Параболический цилиндр</button>
    <button id="ellipse">Эллипсоид</button>
    <button id="hyperboloid" class="crappy">Однополостной гиперболоид</button>
